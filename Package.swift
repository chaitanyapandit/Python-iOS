...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "libpython3", url: "https://github.com/chaitanyapandit/Python-iOS/releases/download/macOS-target/libpython3.xcframework.zip", checksum: "b2f5a8355b92f51e1b6b7cb56919eaf97ce5becb705b7793006e3622dc63a829"),
