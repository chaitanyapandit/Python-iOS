...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "libpython3", url: "https://github.com/chaitanyapandit/Python-iOS/releases/download/macOS-target/libpython3.xcframework.zip", checksum: "bdfd8a66a2d55cf724a51723781201d7c41511faaae7cb23d779de656a5d1b2b"),
